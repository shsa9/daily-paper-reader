...
date: 2026-04-20
pdf: "https://arxiv.org/pdf/2604.17903v2"
tags: ["query:em-force"]
score: 6.0
evidence: 微牛级执行器的精密推力控制
tldr: 本研究针对微牛级尖点场霍尔推力器在推力调节中出现的模式切换问题，通过探针诊断技术分析了其内部等离子体参数及放电特性。研究发现，模式切换源于等离子体密度超过截止密度，导致微波传播特性改变，使电离机制从R波主导的体加热转变为O波主导的表面波加热，为优化推力器控制精度提供了理论依据。
selection_source: fresh_fetch
motivation: 旨在揭示微牛级尖点场霍尔推力器在调节过程中因模式切换导致的电流突变及控制稳定性下降的物理机制。
method: 利用探针诊断实验手段，对比研究了微波模式切换前后推力器内部等离子体分布、发光区域及放电特性的变化。
result: 实验表明模式切换后等离子体密度超过截止密度，导致R波被阻断，电离区域上移且加热机制发生显著改变。
conclusion: 模式切换的根本原因是等离子体密度变化引起的微波传播特性及电子加热机制从体加热向表面波加热的转变。
---

## 摘要
微牛级尖点场霍尔推力器是一种采用微波辅助电离控制的电推进装置。它作为无拖曳控制系统中的执行机构，通过在宽范围内提供连续可调的推力，确保控制精度和稳定性。然而，调节过程中发生的模式转换会导致阳极电流突变，从而降低控制精度和稳定性。因此，有必要研究模式转换的内在规律。本研究主要通过探针诊断，考察了微波模式转换前后推力器内部等离子体参数和放电特性的变化。实验结果表明，在模式转换之前，等离子体发光区主要集中在电子回旋共振（ECR）区域，即阳极上游约1-3 mm处。转换后，发光区进一步向上游移动，阳极附近的等离子体密度超过截止密度，并沿轴向急剧下降。电子加热机制变化的根本原因是等离子体密度变化导致基波传播特性的改变。当等离子体密度上升到截止密度时，驱动电离的R波和O波会迅速衰减或反射。此时，R波无法到达共振层，导致占主导地位的ECR电离失效。电离机制从由R波和O波共同主导转变为主要由O波主导。因此，电子加热机制从体加热转变为表面波加热……
